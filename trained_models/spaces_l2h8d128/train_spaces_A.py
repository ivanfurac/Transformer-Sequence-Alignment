...
train_data_path = '../alignments_100_200/spaces/gap5/alignments_200_gap5_100000'
input_vocab = '../vocab/spaces_vocab'
output_vocab = '../vocab/spaces_output_vocab'
save_model_path = 'spaces_l1h8d128/model.ckpt'
...
checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    ...
    monitor = 'val_accuracy_function',
    mode = 'max',
    save_best_only = True    
)

History = model.fit(train_ds, epochs=num_epochs, validation_data=val_ds, callbacks=[checkpoint_callback], verbose=2)

print('BEST MODEL VALIDATION ACCURACY:')
best = max(History.history['val_accuracy_function'])
print(best)
...
input_vocab = '../vocab/spaces_vocab'
output_vocab = '../vocab/spaces_output_vocab'
save_model_path = 'spaces_l2h8d128/model.ckpt'
